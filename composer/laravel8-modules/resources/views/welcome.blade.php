...
<body class="antialiased">
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4">
    ...
    <div class="w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="flex items-center justify-center sm:justify-start sm:pt-0">
        ...
        @if (Route::has('login'))
          <div class="ml-auto sm:block">
            ...
            @else
              <a href="{{ route('login') }}"
                class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">{{ __('Login') }}</a>
          ...
          <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
            ...
            <div class="ml-12">
              <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                ...
                projects
                to the next level. Pair them with powerful
      ...
      <div class="my-4 flex items-center" style="min-height: calc(100vh - 11rem);">
        <div class="flex:grow-1 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
          @foreach ($allEnabledModules as $module)
            @if (Auth::check() || $module['status'] == 'public')
              <div class="m-2 mx-auto">
                <a href="./{{ $module['slug'] }}" class="flex flex-column justify-center items-center">
                  <span href="./{{ $module['slug'] }}"
                    class="p-2 mb-2 bg-white border-gray-200 dark:bg-gray-800 shadow:hover sm:rounded-lg">
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                      stroke-width="2" viewBox="0 0 24 24" class="w-20 h-20 text-gray-500">
                      <path
                        d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z">
                      </path>
                    </svg>
                  </span>
                  <div class="text-lg leading-7 font-semibold overflow-hidden">
                    {{ $module['name'] }}
                  </div>
                </a>
              </div>
      ...
      <div class="flex justify-between items-center" style="height: 2rem;">
