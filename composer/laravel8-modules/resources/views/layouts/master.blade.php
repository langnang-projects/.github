...
<head>
  ...
  @isset($attributes)
    <link rel="stylesheet"
      href="{{ asset('./modules/' . $attributes['name'] . '/Public/' . \Arr::get($attributes, 'view.framework') . '/style.css') }}">
  @endisset
...
<body class="bg-gray-100 dark:bg-gray-900">
  ...
  <div class="fixed-bottom" style="right: .75rem;bottom: .75rem;left: unset;">
    <ul class="list-group">
      <li class="list-group-item h2 mb-0 p-2"><i class="bi bi-list-nested"></i></li>
      <li class="list-group-item h2 mb-0 p-2" data-toggle="tooltip">
        <i class="bi bi-info-circle-fill"></i>
      </li>
      <li class="list-group-item h2 mb-0 p-2" data-toggle="popover" data-html="true"
        data-content='<ul class="list-style text-left mb-0 pl-3">
              <li><a target="_blank" href="https://necolas.github.io/normalize.css/">normalize.css</a></li>
              <li><a target="_blank" href="https://animate.style/">animate.css</a></li>
              <li><a target="_blank" href="http://www.axios-js.com/">axios</a></li>
              <li><a target="_blank" href="https://jquery.com/">jquery</a></li>
              <li>popper.js</li>
              <li><a target="_blank" href="https://v4.bootcss.com/">bootstrap</a></li>
              <li><a target="_blank" href="https://icons.bootcss.com/">bootstrap-icons</a></li>
              <li><a target="_blank" href="https://simpleicons.org/">simple-icons</a></li>
              <li><a target="_blank" href="http://holderjs.com/">holderjs</a></li>
              <li><a target="_blank" href="https://www.npmjs.com/package/lozad">lozad</a></li>
      </ul>'>
      ...
      <li class="list-group-item h2 mb-0 p-2" data-toggle="popover" data-html="true"
        data-content='<ul class="list-style text-left mb-0 pl-3">
              <li><a target="_blank" href="#">laravel/laravel</a></li>
              <li><a target="_blank" href="#">laravel/lumen</a></li>
      </ul>'>
        <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24">
      ...
      <li class="list-group-item h2 mb-0 p-2"><i class="bi bi-plus-lg"></i></li>
      <a class="list-group-item h2 mb-0 p-2" href="#app"><i class="bi bi-chevron-compact-up"></i></a>
    </ul>
  </div>
  ...
  @isset($attributes)
    <script crossorigin="anonymous"
      src="{{ asset('./modules/' . $attributes['name'] . '/Public/' . \Arr::get($attributes, 'view.framework') . '/script.js') }}">
    </script>
  @endisset
</body>
